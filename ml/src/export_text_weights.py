...
rather than depend on it for the text path we export the vocabulary, IDF
weights and linear coefficients and evaluate them directly in Dart. The model
is linear, so this is exact — not an approximation of the trained pipeline.

Layout matches app/lib/services/scam_text_matcher.dart.
"""
import json
