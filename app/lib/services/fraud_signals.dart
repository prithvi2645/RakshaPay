...
class FraudSignals {
  ...
  // literal list misses all but the exact phrasing it was written for. An
  // under-call here is the dangerous direction: it downgrades a real scam.
  ...
  /// Signals found in [text], as user-facing explanations.
  static List<FraudSignal> detect(String text) {
    ...
    scan(_threats, FraudSignalKind.threat,
        'Threatens to block your account to rush you');
  ...
  /// Whether the message asks the user to do something a scam needs.
